...
namespace AppointmentScheduling.Services
{
    public class AppointmentService : IAppointmentService
    {
        ...
        public async Task<int> AddUpdate(AppointmentVM model)
        {
            ...
            {
                // Update Logic
                var appoinment = _context.Appointments.FirstOrDefault(x => x.Id == model.Id);
                appoinment.Title = model.Title;
                appoinment.Description = model.Description;
                appoinment.StartDate = startDate;
                appoinment.EndDate = endDate;
                appoinment.Duration = model.Duration;
                appoinment.DoctorId = model.DoctorId;
                appoinment.PatientId = model.PatientId;
                appoinment.IsDoctorApproved = false;
                appoinment.AdminId = model.AdminId;
